...
import {
    BlacklistService,
    BlacklistSubscriber,
} from "../../state/store/fileSettings/blacklist/blacklist.service";
...
export class ArtificialIntelligenceController
    implements FilesSelectionSubscriber, BlacklistSubscriber
{
    private _viewModel: {
    ...
    private getAssociatedMetricThresholds(programmingLanguage) {
        return programmingLanguage === "java"
            ? metricThresholds["java"]
            : metricThresholds["miscellaneous"];
    }
}
