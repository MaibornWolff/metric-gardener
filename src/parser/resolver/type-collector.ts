...
export class TypeCollector {
    ...
    private readonly languageToFilesMap = new Map<Language, Map<FilePath, Map<FQTN, TypeInfo>>>();

    getTypesFromFile(parsedFile: ParsedFile): Map<FQTN, TypeInfo> {
